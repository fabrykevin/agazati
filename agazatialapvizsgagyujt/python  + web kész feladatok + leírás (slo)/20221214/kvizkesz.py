...
while kilepes == 'N':
    ...
    while kerdesszama < 1 or kerdesszama > 6:
        kerdesszama = int(input('Kérdés sorszáma: '))
    valasz = kerdes(kerdesszama)
    eldont(valasz,kerdesszama)
    kilepes = input('Ki szeretne lépni [I/N]? ')
